...
test_that("pbeta_post works", {
  ...
  expect_equal(pbeta_post(2, likelihood = "binom", result = 2, sample_size = 10),
               pbeta(2, 0.5 + 2, 10 - 2 + 0.5))
  expect_equal(
    pbeta_post(2, likelihood = "nbinom", result = 2, sample_size = 10, failure_rate = 0.5),
    pbeta(2, 0.5 + 10 * 0.5, 2 + 0.5))
  expect_equal(pbeta_post(2, likelihood = "geometric", result = 2, sample_size = 10),
...
test_that("rbeta_post works", {
  ...
  expect_equal(
    withr::with_seed(
      123,
      rbeta_post(
        2, likelihood = "nbinom", result = 2, sample_size = 10, failure_rate = 0.5)
      ),
